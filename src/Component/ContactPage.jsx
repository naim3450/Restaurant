  ...
  return (
    <div className="pb-[800px] relative">
        <div className="absolute top-64 left-[620px]">
            ...
            <h1 className="font-serif text-prh2 font-normal text-center text-[100px]">Contact Us</h1>
            ...
            <div className="flex justify-center gap-12 mt-10">
                <div className="">
                    ...
                    <p className="font-serif font-bold text-btn text-2xl">+1-234-567-8900</p>
                </div>
                <div className="">
                    <p className="font-serif font-bold text-[20px]">Hours:</p>
                    <p className="font-serif text-lg">Mon-Fri: 11am - 8pm Sat,</p> 
                      <span className="font-serif text-lg" >Sun: 9am - 10pm.</span> 
                </div>
                <div className="">
                    <p className="font-serif font-bold text-[20px]">Our location:</p>
                    <p className="w-[210px] font-serif text-lg">123 Bridge Street, Nowhere Land, LA 12345 United States</p>
                </div>
